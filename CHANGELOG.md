...
Initial implementation: IAM role and IAM Identity Center profiles across the
standard, GovCloud (US), and China partitions; deterministic soft colors;
favorites, recents, tags, and account masking; production confirmation; strict
AWS config import; local JSON backup and restore; light, dark, and system
themes; Manifest V3 builds for Chrome, Edge, Firefox, and Safari.
